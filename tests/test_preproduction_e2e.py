...
class PreproductionE2ETests(unittest.IsolatedAsyncioTestCase):
    ...
    @patch("modules.router.calendar_actions.create_from_text", new_callable=AsyncMock, return_value=True)
    ...
    @patch("modules.router.calendar_user.view_from_text", new_callable=AsyncMock, return_value=True)
    ...
    @patch("modules.router.calendar_actions.delete_from_text", new_callable=AsyncMock, return_value=True)
    ...
    @patch("modules.router.calendar_actions.update_from_text", new_callable=AsyncMock, return_value=True)
    ...
    @patch("modules.router.calendar_availability.free_slots_from_text", new_callable=AsyncMock, return_value=True)
