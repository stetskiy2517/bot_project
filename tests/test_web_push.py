...
class WebPushApiTests(unittest.TestCase):
    ...
    def test_pwa_shell_loads_push_client(self):
        ...
        self.assertIn('personal-secretary-v15-fullscreen-task-editor', worker)
        ...
        self.assertIn('"/task-swipe.js"', worker)
        self.assertIn('"/prebeta-polish.js"', worker)
        self.assertIn('"/ux-polish.js"', worker)
