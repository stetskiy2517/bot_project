...
EVENT_CATEGORIES = {
    ...
    "personal": {"color_id": "5", "keywords": ("личн", "дом", "покуп", "купить", "куплю", "купи", "магазин", "день рождения", "забрать", "отвезти", "ужин", "обед", "завтрак", "уборк", "стирк", "готов", "душ", "свидан", "люблю", "любов")},
}
