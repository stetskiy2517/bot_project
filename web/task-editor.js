(() => {
  ...
  style.textContent = `
    ...
    .planner-snackbar.show{opacity:1;transform:translate(-50%,0);pointer-events:auto}.planner-snackbar-text{min-width:0;flex:1;font-size:13px;line-height:1.35}.planner-snackbar-action{flex:0 0 auto;min-height:44px;padding:8px 12px;border-radius:10px;background:#3b3b3b;color:#fff;font-weight:700;cursor:pointer}
