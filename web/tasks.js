(() => {
  ...
  function install() {
    ...
    style.textContent = `
      ...
      .planner-task-header-icon{position:relative;width:44px;height:44px;flex:0 0 44px;display:grid;place-items:center;border-radius:12px;background:#e9e9e6;color:#252524;cursor:pointer;transition:transform .16s ease,background .16s ease,color .16s ease}
      ...
      .planner-task-filters{display:grid;grid-template-columns:1fr 1fr;gap:8px;margin:0 0 10px}.planner-task-filter{min-width:0;min-height:44px;padding:0 9px;border:1px solid #dededb;border-radius:11px;background:#fff;color:#333;font:inherit;font-size:12px;outline:0}
      ...
      .planner-task-actions{display:flex;gap:6px;flex-wrap:wrap;margin-top:11px}.planner-task-action{min-height:44px;padding:0 10px;border-radius:10px;background:#efefed;color:#333;font-size:12px;font-weight:600;cursor:pointer}.planner-task-action.danger{background:#f2dddd;color:#8a2d2d}
      ...
      @media(max-width:520px){.planner-task-filters{grid-template-columns:1fr 1fr}.planner-task-header-icon{width:44px;height:44px;flex-basis:44px;border-radius:12px}.planner-task-search-shell{width:44px;height:44px;flex-basis:44px}.planner-task-search-input{right:50px;height:44px}}
    `;
